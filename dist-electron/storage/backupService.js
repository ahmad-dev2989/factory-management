 ...
 */
export async function createBackupZip(destZipPath, progressCallback) {
 ...
 */
export async function validateBackupZip(srcZipPath, tempExtractPath, progressCallback) {
 ...
 */
export async function applyRestore(tempExtractPath, backupRollbackPath) {
    const userDataPath = app.getPath('userData');
    const dbPath = path.join(userDataPath, 'factory.db');
 ...
 */
export async function rollbackRestore(backupRollbackPath) {
    const userDataPath = app.getPath('userData');
    const dbPath = path.join(userDataPath, 'factory.db');
